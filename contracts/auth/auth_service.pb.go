...
var file_auth_auth_service_proto_rawDesc = []byte{
	...
	0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x59, 0x0a, 0x0f,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x0e, 0x6c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x2b, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	0x64, 0x22, 0x53, 0x0a, 0x09, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x61, 0x69, 0x72, 0x12, 0x21,
	...
	0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xd3, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x2c, 0x0a, 0x05, 0x4c, 0x6f,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x61, 0x69, 0x72, 0x12, 0x30, 0x0a, 0x07, 0x52, 0x65, 0x66, 0x72,
	...
	0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x50, 0x61, 0x69, 0x72, 0x12, 0x39, 0x0a, 0x08, 0x56, 0x61,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x12,
	...
	0x73, 0x74, 0x75, 0x64, 0x79, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x2f,
...
var file_auth_auth_service_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.DeleteUser:input_type -> auth.DeleteUserRequest
	7, // 6: auth.Auth.Register:output_type -> google.protobuf.Empty
	6, // 7: auth.Auth.Login:output_type -> auth.TokenPair
	6, // 8: auth.Auth.Refresh:output_type -> auth.TokenPair
	4, // 9: auth.Auth.Validate:output_type -> auth.ValidateResponse
	7, // 10: auth.Auth.Logout:output_type -> google.protobuf.Empty
	7, // 11: auth.Auth.DeleteUser:output_type -> google.protobuf.Empty
...
func file_auth_auth_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_auth_auth_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_auth_auth_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_auth_auth_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_auth_auth_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_auth_auth_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_auth_auth_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_auth_auth_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
